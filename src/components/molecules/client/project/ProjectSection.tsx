...
const ProjectSection = () => {
  return (
    <div className="w-[90%] md:w-[100%] px-0 flex flex-wrap pb-10 flex-col lg:flex-row text-primaryTextColor gap-8">
        <h4 className='py-6 mt-3 text-3xl sm:text-4xl md:text-5xl font-medium text-primaryColor'>I can help you with...</h4>
        ...
        <h4 className='py-6 mt-3 text-3xl sm:text-4xl md:text-5xl font-medium text-primaryColor'>Skills i offer...</h4>
        <div className='flex flex-col lg:flex-row gap-10 lg:gap-1'>
