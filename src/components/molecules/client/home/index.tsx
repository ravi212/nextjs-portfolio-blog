...
const HomeSection = () => {
  return (
    <div className="w-[100%] md:w-[90%] h-auto mx-0 my-10 flex flex-col text-primaryTextColor gap-6">
        ...
        <h1 className="text-6xl sm:text-5xl md:text-7xl font-medium text-primaryColor">Software <span className="font-normal text-primaryColor"> Developer</span></h1>
        ...
        <div className='flex flex-col md:flex-row gap-1'>
            {
                EXPERTISE.map((item, index) => (
                    <div className='flex border-l-gray-300 border-l min-w-[33%] p-8 flex-col gap-3'>
